...
\begin{description}
    ...
    \item A group cannot be assigned to a classroom if another group has that classroom assigned to it and they collision (they overlap in week and schedule).
\end{description}
