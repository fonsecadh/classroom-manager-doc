...
\fancyfoot[C]
{
    \begin{tabular}{|ll|c}
        \hline
        \multicolumn{3}{|l|}{\textbf{Author:} Hugo Fonseca Díaz} \\ 
        \hline
        Classroom Manager                  & \version        & \multicolumn{1}{c|}{\multirow{2}{*}{Page \thepage \hspace{1pt} of {\hypersetup{linkcolor=black} \pageref*{LastPage}}}} \\ \cline{1-2}
        Final Degree Project  & \textbf{Entity:} School of Computer Engineering  & \multicolumn{1}{c|}{}                                \\ \hline
    \end{tabular}
}
