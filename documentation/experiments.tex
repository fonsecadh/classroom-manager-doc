...
Next, the two algorithms will be compared on the other metrics. The four tables in the greedy review are summarised in two tables (See Tables \ref{table-greedgen-met-01} and \ref{table-greedgen-met-02}).
